//lembrando que vou ter que formatar essa bomba em TYPESCRIPT ainda
...
const fAmount = document.getElementById("f-amount") as HTMLInputElement;
...
const changeNote = document.getElementById("change-note") as HTMLElement;
...
function render(): void {
  ...
  const balEl = document.getElementById("total-balance") as HTMLElement;
...
btnSave?.addEventListener("click", () => {
  ...
  if (editingId) {
    ...
    Object.assign(tx, {
      desc,
      amount,
      type: fType.value as TransactionType,
      cat: fCat.value,
      date: fDate.value,
    });
  } else {
